...
/**
 * REST controller for managing {@link com.rj.dinosaurs.gateway.domain.Dinosaur}.
 */
@RestController
@RequestMapping("/api")
public class DinosaurResource {
    ...
    public ResponseEntity<DinosaurDTO> updateDinosaur(@Valid @RequestBody DinosaurDTO dinosaurDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, dinosaurDTO.getId().toString()))
            .body(result);
    }
