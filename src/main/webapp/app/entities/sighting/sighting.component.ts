...
export class SightingComponent implements OnInit, OnDestroy {
  ...
  registerChangeInSightings(): void {
    this.eventSubscriber = this.eventManager.subscribe('sightingListModification', () => this.reset());
  }
  ...
  protected paginateSightings(data: ISighting[] | null, headers: HttpHeaders): void {
