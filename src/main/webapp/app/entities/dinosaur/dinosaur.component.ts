...
export class DinosaurComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.dinosaurService
        ...
        .subscribe(
          (res: HttpResponse<IDinosaur[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  protected onSuccess(data: IDinosaur[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
