...
export class EpochComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.epochService
        ...
        .subscribe(
          (res: HttpResponse<IEpoch[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  protected onSuccess(data: IEpoch[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
