...
import { EpochComponent } from 'app/entities/epoch/epoch.component';
import { EpochService } from 'app/entities/epoch/epoch.service';
import { Epoch } from 'app/shared/model/epoch.model';

describe('Component Tests', () => {
  describe('Epoch Management Component', () => {
    let comp: EpochComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EpochComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.epoches && comp.epoches[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
